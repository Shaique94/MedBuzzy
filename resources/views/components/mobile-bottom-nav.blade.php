    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200/50 z-50 lg:hidden">
        <div class="flex items-center justify-around py-3 px-2 max-w-lg mx-auto">
            ...
            <a 
                ...
                :class="{ 'text-brand-teal-600': activeTab === 'hero' }"
            ...
            >
                <div class="relative w-10 h-10 flex items-center justify-center rounded-full transition-all duration-200"
                    :class="activeTab === 'hero' 
                        ? 'bg-brand-teal-600 text-white scale-110' 
                        : 'bg-gray-100 text-gray-600 group-hover:bg-brand-teal-50 group-hover:text-brand-teal-600'">
                ...
                <span class="text-[10px] font-medium transition-colors"
                      :class="activeTab === 'hero' ? 'text-brand-teal-600' : 'text-gray-500'">Home</span>
            </a>
            ...
            <a 
                ...
                class="flex flex-col items-center space-y-1 p-2 rounded-xl transition-all duration-200 group"
                :class="{ 'text-brand-teal-600': activeTab === 'our-doctors' }"
            ...
            >
                ...
                <span class="text-[10px] font-medium transition-colors"
                      :class="activeTab === 'our-doctors' ? 'text-brand-teal-600' : 'text-gray-500'">Find Doctor</span>
            </a>
            ...
            >
                <div class="relative w-12 h-12 flex items-center justify-center rounded-full transition-all duration-200 shadow-lg"
                    ...
                    <div x-show="activeTab === 'appointment'" 
                         class="absolute -top-1 -right-1 w-3 h-3 bg-brand-teal-500 rounded-full border-2 border-white"></div>
                </div>
                <span class="text-[10px] font-medium transition-colors"
            ...
            <a 
                ...
                class="flex flex-col items-center space-y-1 p-2 rounded-xl transition-all duration-200 group"
            >
                <div class="relative w-10 h-10 flex items-center justify-center rounded-full transition-all duration-200 bg-gray-100 text-gray-600 group-hover:bg-brand-teal-50 group-hover:text-brand-teal-600">
