...
@forelse ($appointments as $appointment)
 ...
 <p class="font-medium text-gray-800">{{$appointment->date.now()}}</p>
                                        ...
                                        <td class="py-4">
                                            <p class="font-medium"> {{ \Carbon\Carbon::parse($appointment->appointment_time)->format('h:i A') }}</p>
                                            <p class="text-sm text-gray-600">  {{ \Carbon\Carbon::parse($appointment->appointment_date)->isToday() ? 'Today' : \Carbon\Carbon::parse($appointment->appointment_date)->format('M d, Y') }}
                                    </p>
                                        </td>
