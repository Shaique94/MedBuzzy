<div
    class="lg:min-h-screen bg-gradient-to-br from-teal-50 via-white to-teal-100 flex items-center justify-center p-2 sm:p-4">
    <div
        class="bg-white p-4 sm:p-6 lg:p-10 rounded-2xl w-full max-w-md sm:max-w-md lg:max-w-lg mx-auto transition-all duration-300 border border-teal-100/50">
        ...
        @if (session()->has('success'))
            <div
                class="bg-teal-50 border border-teal-200 text-teal-700 px-3 sm:px-4 py-3 rounded-lg mb-4 sm:mb-6 flex items-start text-sm">
            ...
            <div>
                ...
                <div class="relative rounded-md shadow-sm">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-4 w-4 sm:h-5 sm:w-5 text-teal-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20" fill="currentColor">
            ...
            <div>
                <div class="flex justify-between items-center mb-1 sm:mb-1.5">
                    ...
                    <a wire:navigate href="{{ route('password.request') }}"
                        class="text-xs text-teal-600 hover:text-teal-700 hover:underline transition duration-150">
                        Forgot password?
                    </a>
                </div>
                <div class="relative rounded-md shadow-sm">
            ...
            <div class="pt-1">
                ...
                <p class="mt-4 sm:mt-6 text-center text-xs sm:text-sm text-gray-600">
                    ...
                    <a wire:navigate href="{{ route('register') }}"
                        class="font-medium text-teal-600 hover:text-teal-500 hover:underline transition duration-150">Sign
                        up</a>
                </p>
            </div>
        </form>
