<div class="lg:min-h-screen bg-gradient-to-br from-brand-blue-50 via-white to-brand-blue-100 flex items-center justify-center p-2 sm:p-4">
    <div class="bg-white p-4 sm:p-6 lg:p-10 rounded-2xl w-full max-w-md sm:max-w-md lg:max-w-lg mx-auto transition-all duration-300 border border-brand-blue-100/50">
        ...
        @if (session()->has('success'))
            <div class="bg-brand-blue-50 border border-brand-blue-200 text-brand-blue-700 px-3 sm:px-4 py-3 rounded-lg mb-4 sm:mb-6 flex items-start text-sm">
        ...
        <form wire:submit.prevent="login" class="space-y-4 sm:space-y-5">
            <!-- Email Field -->
            <div>
                <label for="email" class="block text-sm font-medium text-gray-700 mb-1 sm:mb-1.5">Email
                    Address</label>
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input type="email" id="email" wire:model.defer="email" placeholder="your@email.com"
                        class="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-blue-500 focus:border-brand-blue-500 transition duration-150 placeholder-gray-400 @error('email') border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500 @enderror">
                </div>
                @error('email')
            ...
            <div>
                <div class="flex justify-between items-center mb-1 sm:mb-1.5">
                    ...
                    <a wire:navigate href="{{ route('password.request') }}" class="text-xs text-brand-blue-600 hover:text-brand-blue-700 hover:underline transition duration-150">Forgot password?</a>
                </div>
                <div class="relative rounded-md shadow-sm">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-4 w-4 sm:h-5 sm:w-5 text-brand-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="flex items-center">
                <input type="checkbox" id="remember" wire:model.defer="remember"
                    class="h-3 w-3 sm:h-4 sm:w-4 text-brand-blue-600 focus:ring-brand-blue-500 border-gray-300 rounded">
            ...
            <div class="pt-1">
                ...
                <a  href="{{ route('google.login') }}"
                    class="w-full flex justify-center items-center py-2 sm:py-2.5 px-4 border border-gray-300 rounded-lg text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue-500 transition duration-150 ease-in-out shadow-sm hover:shadow-md">
                ...
                <p class="mt-4 sm:mt-6 text-center text-xs sm:text-sm text-gray-600">
                    ...
                    <a wire:navigate href="{{ route('register') }}" class="font-medium text-brand-blue-600 hover:text-brand-blue-500 hover:underline transition duration-150">Sign up</a>
                </p>
            </div>
        </form>
