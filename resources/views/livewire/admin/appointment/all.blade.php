<div class="bg-white m-2 shadow   rounded-xl overflow-hidden">
    <!-- Header Section -->
    <div class="bg-blue-500 px-4 sm:px-5 lg:px-8 py-4 md:py-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
            <div class="flex items-center space-x-3 sm:space-x-4">
                ...
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold">Appointment Management</h1>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 bg-blue-50 rounded-full flex items-center justify-center">
                                    <i class="fas fa-user-md text-blue-500 text-sm sm:text-base"></i>
                                </div>
                                <div class="ml-3 sm:ml-4">
                                    <div class="text-sm font-semibold text-gray-900 truncate max-w-[120px] sm:max-w-none">
                        ...
                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 bg-purple-50 rounded-full flex items-center justify-center">
                        ...
                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                            ...
                            @else
                                <span
                                    class="px-2 py-1 inline-flex text-xs leading-4 font-semibold rounded-full bg-gray-100 text-gray-800">
