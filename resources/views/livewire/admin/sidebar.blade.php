<aside id="sidebar"
    ...
    <div class="flex flex-col h-full">
        ...
        <div
            ...
            <img src="/logo/logo.png" alt="MedBuzzy Logo" class="h-10 lg:h-12 mt-4 lg:block hidden">
        </div>
        <!-- Navigation -->
        ...
        <div class="border-t border-gray-200 p-3 lg:p-4">
            ...
            <form method="POST" action="{{ route('logout') }}" class="w-full">
                @csrf
                <button type="submit"
                    class="sidebar-link flex items-center w-full px-3 lg:px-4 py-3 text-red-600 responsive-text-base hover:bg-red-50">
