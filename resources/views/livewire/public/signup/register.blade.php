<div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden my-8">
    <div class="md:flex">
        ...
        <div class="md:w-1/2 p-8 bg-brand-blue-50 text-brand-blue-900 border-r border-brand-blue-100">
            <div class="mb-8 flex justify-center">
                <img src="/logo/logo.png" alt="MedBuzzy Logo" class="h-16 w-auto">
            </div>
            
            <div class="max-w-md mx-auto">
                <h1 class="text-3xl font-bold mb-4 text-center text-brand-blue-800">Join MedBuzzy Today</h1>
        ...
        <div class="md:w-1/2 p-8">
            <h2 class="text-2xl font-bold text-brand-blue-800 mb-2">Create Account</h2>
            <p class="text-brand-blue-600 mb-6">Fill in your details to get started</p>
