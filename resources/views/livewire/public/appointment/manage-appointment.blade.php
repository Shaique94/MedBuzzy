                ...
                {{ !$selectedDepartment ? 'ring-2 ring-brand-teal-500 bg-brand-teal-50 border-brand-teal-200' : 'bg-gradient-to-br from-brand-teal-50 to-brand-orange-50 hover:to-brand-orange-100 hover:shadow-md' }}"
                    ...
                    @if ($step === 4)
                        <div class="space-y-4 md:space-y-6 md:max-w-5xl mx-auto px-2 sm:px-0">
                            ...
                            <div
                                class="bg-white rounded-xl shadow-lg border border-brand-teal-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
                                <!-- Header -->
                                ...
                                <div class="p-4 sm:p-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <!-- Doctor Info -->
                                        <div
                                            class="flex space-x-4 p-3 rounded-lg bg-brand-teal-50 border border-brand-teal-100">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden bg-white border-2 border-brand-teal-300 shadow-md">
                                                    <img src="{{ $selectedDoctor->image ?? 'https://ui-avatars.com/api/?name=' . urlencode($selectedDoctor->user->name) . '&background=random&rounded=true' }}"
                                                        alt="Dr. {{ $selectedDoctor->user->name }}"
                                                        class="w-full h-full object-cover">
                                                </div>
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <span
                                                    class="text-xs font-medium text-brand-teal-600 uppercase tracking-wider">Your
                                                    Doctor</span>
                                                <h4
                                                    class="text-sm sm:text-base md:text-lg font-bold text-gray-800 mt-1">
                                                    Dr. {{ $selectedDoctor->user->name }}</h4>
                                                <p class="text-xs sm:text-sm text-gray-600 mt-1">
                                                    {{ $selectedDoctor->department->name }}</p>
                                                <div class="flex items-center mt-2">
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-brand-teal-100 text-brand-teal-800">
