<div><div class="min-h-screen p-1 sm:px-0 lg:px-0 bg-gray-50">
    <div class="w-full max-w-none mx-0">
        ...
        <div class="bg-white w-full rounded-none border-t border-b border-gray-200">
            ...
            4 => ['label' => 'Confirm', 'icon' => 'check-circle'],
                        ...
                        <div class="flex flex-col items-center relative flex-1 min-w-[90px] sm:min-w-0 px-1">
                            ...
                            @if ($stepNumber < 4)
                                ...
                                <div
                                    class="block sm:hidden absolute top-4 left-1/2 w-[80%] h-0.5 {{ $step > $stepNumber ? 'bg-brand-teal-600' : 'bg-gray-300' }}"
            ...
            <div class="px-0 py-4 border-t border-gray-200 bg-gray-50 w-full">
                <div class="flex flex-col sm:flex-row justify-between gap-4 max-w-5xl mx-auto">
                    @if ($step > 1)
...
/* Remove box-shadow from all elements in this booking UI */
.shadow, .shadow-md, .shadow-lg, .shadow-xl, .shadow-sm, .hover\:shadow-md, .hover\:shadow-lg, .hover\:shadow-xl, .hover\:shadow-sm, .shadow-inner, .hover\:shadow, .focus\:shadow, .active\:shadow {
