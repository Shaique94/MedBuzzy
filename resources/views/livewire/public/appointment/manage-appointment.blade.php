                                ...
                                @if (!$appointment_date)
                                    <div class="bg-white p-2 rounded-xl  ">
                                        ...
                                        <div class="bg-white rounded-xl border border-gray-200  overflow-hidden">
                                            <div
                                                class="grid grid-cols-7 gap-1 text-center text-sm font-semibold text-gray-600 bg-gray-50 py-3">
                                            ...
                                            <div class="grid grid-cols-7 gap-1 text-center text-sm p-2">
                                                @for ($i = 0; $i < $startDayOfWeek; $i++)
                                                    <div class="bg-gray-50 rounded-lg h-10"></div>
                                                @endfor
                                                @for ($day = 1; $day <= $daysInMonth; $day++)
                                                    @php
                                                        ...
                                                        $isBookable =
                                                            $isWithinBookingRange && $isAvailableDay && !$isOnLeave;
                                                    ...
                                                    <button wire:key="day-{{ $day }}"
                                                        ...
                                                        class="w-full h-10 rounded-lg transition-all duration-200 flex flex-col items-center justify-center
                                                    ...
                                                    {{ $isToday ? 'border-2 border-blue-400 text-blue-600 font-semibold' : '' }}"
                                                        ...
                                                        {{ $day }}
                                                        @if ($isToday)
                                                            <span class="text-[8px] text-blue-600">Today</span>
                                                        @endif
                                                    </button>
                                                @endfor
                                            </div>
                                        ...
                                        <!-- Legend -->
                                        <div class="mt-5 flex flex-wrap gap-3 justify-center text-xs text-gray-600">
                                            <div class="flex items-center">
                                                <div
                                                    class="w-3 h-3 bg-brand-teal-50 border border-brand-teal-200 rounded-full mr-2">
                                                </div>
                                                <span>Available</span>
                                            </div>
                                            <div class="flex items-center">
                                                <div
                                                    class="w-3 h-3 bg-brand-orange-100 border border-brand-orange-300 rounded-full mr-2">
                                                </div>
                                                <span>On Leave</span>
                                            </div>
                                            <div class="flex items-center">
                                                <div
                                                    class="w-3 h-3 bg-red-100 border border-red-300 rounded-full mr-2">
                                                </div>
                                                <span>Not Available</span>
                                            </div>
                                            <div class="flex items-center">
                                                <div
                                                    class="w-3 h-3 bg-gray-100 border border-gray-200 rounded-full mr-2">
                                                </div>
                                                <span>Past</span>
                                            </div>
                                            <div class="flex items-center">
