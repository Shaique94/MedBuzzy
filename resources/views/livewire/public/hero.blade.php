<div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                    ...
                    <div class="flex-1 text-center lg:text-left space-y-6 lg:space-y-8">
                        <div class="space-y-4">
                            <div
                                class="inline-flex items-center px-4 py-2 bg-teal-100 text-teal-800 rounded-full text-sm font-medium">
                            ...
                            <form wire:submit.prevent="search" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="location" wire:model="location" disabled  aria-label="Current location: Purnea, Bihar"
                                    ...
                                    <div class="relative">
                                       ...
                                       <select name="specialty" wire:model="selectedDepartment"  aria-label="Select medical specialty"
    ...
    @endforeach
                                ...
                                <div class="relative">
                                    ...
                                    <button type="submit"
                                        class="absolute inset-y-0 right-0 px-6 py-2 m-1 bg-teal-700 text-white rounded-lg hover:bg-teal-700 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500">
                                        Search
                                    </button>
                                </div>
                            </form>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a wire:navigate href="{{ route('appointment') }}"
                                class="bg-gradient-to-r from-orange-600 to-red-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-orange-600 hover:to-red-600 transition-all w-full duration-200 flex items-center justify-center space-x-2">
                        ...
                        <div class="grid grid-cols-3 gap-4 pt-8">
                            <div class="text-center">
                                ...
                                <div class="text-sm text-gray-700">Expert Doctors</div>
                            </div>
                            <div class="text-center">
                    ...
                    <div class="flex-1 w-full max-w-lg lg:max-w-none">
                        <div x-data="{
                            ...
                            <div class="bg-teal-700 rounded-3xl p-8 lg:p-12">
                                        ...
                                        <div x-show="current === {{ $index }}" aria-live="polite"
                                            ...
                                            <div class="flex items-center gap-2 sm:gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-xs sm:text-sm text-teal-900 font-medium truncate">{{ $doctor->department->name ?? 'General Medicine' }}</div>
                                                </div>
                                                <div class="text-right">
                                                    <div class="flex text-yellow-400 justify-end mb-1" aria-hidden="true">
                                                        @php
...
if (!$nextSlot) {
    $nextSlot = [
        ...
        'time' => 'availability',
                                                    ...
                                                    <div class="text-[10px] sm:text-xs text-teal-800">₹{{ $doctor->fee ?? 500 }} consultation</div>
                                                </div>

                                                <div class="grid grid-cols-2 gap-2 text-sm">
                                                    <div class="bg-gray-50 rounded p-1 sm:p-2 text-center  border border-gray-200">
                                                        <div class="font-medium text-gray-900 text-xs sm:text-sm">{{ $doctor->experience ?? '5+' }} yrs</div>
                                                        <div class="text-[9px] sm:text-xs text-gray-700">Experience</div>
                                                    </div>
                                                ...
                                                <a wire:navigate href="{{ route('appointment', ['doctor_slug' => $doctor->slug]) }}"
                                                    class="w-full block py-2 sm:py-3 rounded-lg font-medium hover:bg-teal-700 transition-colors text-center text-sm sm:text-base">
                                                    Book Appointment
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <!-- Dots -->
                            <div class="flex justify-center gap-2 mt-4" role="tablist" aria-label="Doctor carousel navigation dots">
                                @foreach ($doctors as $index => $doctor)
                                    <button @click="goTo({{ $index }})"
                                        :class="current === {{ $index }} ? 'bg-teal-600' : 'bg-teal-300'"
