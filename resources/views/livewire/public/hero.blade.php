<div>
    <section class="relative overflow-hidden bg-gradient-to-br from-brand-teal-50 to-white py-16 lg:py-24">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            <!-- Search box -->
            <div class="max-w-5xl mx-auto bg-white rounded-xl shadow-xl p-6 lg:p-8 mb-14 lg:mb-16 border border-gray-100">
                <form action="/search" method="GET" wire:submit.prevent="search" class="space-y-4 md:space-y-0">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        ...
                        <div class="md:col-span-3">
                            <div class="relative">
                                ...
                                <select name="location" wire:model="location" class="block w-full pl-10 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-teal-500 focus:border-brand-teal-500 rounded-lg">
                        ...
                        <div class="md:col-span-3">
                            <div class="relative">
                                ...
                                <select name="specialty" wire:model="specialty" class="block w-full pl-10 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-teal-500 focus:border-brand-teal-500 rounded-lg">
                        ...
                        <div class="md:col-span-5">
                            <div class="relative">
                                ...
                                <input type="text" name="search" wire:model="searchQuery" placeholder="Search doctors, clinics, or conditions" class="block w-full pl-10 pr-4 py-3 border border-teal-300 focus:outline-none focus:ring-2 focus:ring-brand-teal-500 focus:border-brand-teal-500 rounded-lg">
                            </div>
                        </div>
                        
                        <!-- Search button -->
                        <div class="md:col-span-1">
                            <button type="submit" class="w-full h-full flex items-center justify-center bg-brand-teal-600 text-white rounded-lg hover:bg-brand-teal-700 transition-colors">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/book-appointment" class="bg-brand-orange-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-brand-orange-700 transition-colors text-center flex items-center justify-center shadow-md hover:shadow-lg">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        Book Appointment
                    </a>
                    <a href="/emergency" class="bg-teal-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-900 transition-colors text-center flex items-center justify-center shadow-md hover:shadow-lg">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
