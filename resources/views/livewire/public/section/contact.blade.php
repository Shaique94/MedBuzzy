                    ...
                    <div class="space-y-6">
                        <div class="flex items-start p-4 bg-brand-teal-50 rounded-lg">
                            <div class="flex-shrink-0 bg-brand-teal-100 rounded-md p-3">
                                <svg class="h-6 w-6 text-brand-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="p-6 sm:p-8">
                            ...
                            <form class="space-y-6" wire:submit.prevent="submitContactForm">
                                ...
                                <div>
                                    <button 
                                        type="submit"
                                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-teal-600 hover:bg-brand-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-teal-500 transition duration-150"
