<div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold tracking-tight text-brand-teal-800 sm:text-5xl md:text-6xl">
                    ...
                    <span class="block text-brand-orange-500">We're here to help</span>
                </h1>
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
                ...
                <div class="space-y-8">
                    <div>
                        <h2 class="text-2xl font-bold text-brand-teal-800">Get in touch</h2>
                    ...
                    <!-- Contact Cards -->
                    <div class="space-y-6">
                        <div class="flex items-start p-4 bg-brand-teal-50 rounded-lg">
                            <div class="flex-shrink-0 bg-brand-teal-100 rounded-md p-3">
                                <svg class="h-6 w-6 text-brand-teal-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-600"><a href="tel:{{ $contactDetails['phone'] }}"
                                        class="hover:text-brand-teal-600 transition-colors">{{ $contactDetails['phone'] }}</a>
                                </p>
                        ...
                        <div class="flex items-start p-4 bg-brand-teal-50 rounded-lg">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-600"><a href="mailto:{{ $contactDetails['email'] }}"
                                        class="hover:text-brand-teal-600 transition-colors">{{ $contactDetails['email'] }}</a>
                                </p>
                        ...
                        <div class="flex items-start p-4 bg-brand-teal-50 rounded-lg">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-2 text-sm text-brand-teal-600 flex items-start">
                                    <svg class="flex-shrink-0 h-4 w-4 mt-0.5 mr-1" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Map Section -->
                    <div class="mt-8">
                        <h3 class="text-xl font-bold text-brand-teal-800 mb-4">Our Location</h3>
                ...
                <div>
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <div class="p-6 sm:p-8">
                            <h2 class="text-2xl font-bold text-brand-teal-800 mb-6">Send us a message</h2>
                            ...
                            <form class="space-y-6" wire:submit.prevent="submit">
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="name" wire:model="name"
                                            class="py-3 px-4 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-brand-teal-500 focus:border-brand-teal-500 transition duration-150"
                                ...
                                <div>
                                    <button type="submit"
                                        class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-teal-600 hover:bg-brand-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-teal-500 transition duration-150"
    ...
    <div class="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-brand-teal-800 sm:text-4xl">
            ...
            <div class="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h3 class="text-lg font-medium text-brand-teal-800">How do I book an appointment?</h3>
                ...
                <!-- FAQ Item 3 -->
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h3 class="text-lg font-medium text-brand-teal-800">Do you offer emergency services?</h3>
                    <p class="mt-2 text-gray-600">
