        ...
        <div class="md:hidden">
            <div class="flex flex-col items-center mb-8">
                ...
                <div class="flex space-x-4 mb-8">
                    <a wire:navigate href="#" class="h-10 w-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-teal-600 transition-colors">
        ...
        <div class="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-3 pt-2">
                    <a wire:navigate href="#" class="h-8 w-8 bg-gray-700 rounded-full flex items-center justify-center hover:bg-teal-600 transition-colors">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"></path>
                        </svg>
                    </a>
