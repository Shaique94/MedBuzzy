<div><footer class="bg-brand-blue-900 text-white pt-12 pb-10">
    <div class="container mx-auto px-4">
        ...
        <div class="md:hidden">
            <div class="flex flex-col items-center mb-8">
                ...
                <div class="flex space-x-4 mb-8">
                   ...
                   <a href="https://instagram.com/medbuzzy" target="_blank" rel="noopener noreferrer" aria-label="Instagram"

                     class="h-10 w-10 bg-gradient-to-br from-purple-600 via-pink-600 to-brand-yellow-500 rounded-full flex items-center justify-center hover:from-purple-500 hover:via-pink-500 hover:to-brand-yellow-400 transition-all duration-300 shadow-lg hover:shadow-pink-500/50 hover:scale-110 transform">
                        <svg aria-hidden="true" class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.youtube.com/@Medbuzzy" target="_blank" rel="noopener noreferrer" aria-label="YouTube"
                ...
                <div class="border-b border-gray-700">
                    ...
                    <div x-show="activeSection === 'contact'" style="display: none;">
                        <ul class="space-y-4 pl-2 py-3">
                            <li>
                                <a href="tel:{{ $contactDetails['phone'] }}" class="flex items-center text-gray-400 hover:text-white"  aria-hidden="true">
                                    <div class="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center mr-3">
                                        <svg class="h-4 w-4 text-brand-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <li>
                                <a href="mailto:{{ $contactDetails['email'] }}" class="flex items-center text-gray-400 hover:text-white"  aria-hidden="true">
                                    <div class="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center mr-3">
                                        <svg class="h-4 w-4 text-brand-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-3 pt-2">
                    <a href="https://www.facebook.com/people/Med-Buzzy/pfbid02D56pbCqxDNPcrX2ZP9jjkwzLgyto89DEkGn11bArtcGx4HLEzpWfFeVDEwG8cHuSl/"   aria-label="Facebook" 
                       target="_blank" 
                       rel="noopener noreferrer" class="h-8 w-8 bg-gradient-to-br from-brand-blue-600 to-brand-blue-800 rounded-full flex items-center justify-center hover:bg-brand-blue-500 transition-all duration-300 shadow-md hover:shadow-brand-blue-500/50 hover:scale-110 transform">
                        <svg class="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"></path>
                        </svg>
                    </a>
                    <a href="https://instagram.com/medbuzzy" target="_blank" rel="noopener noreferrer"   aria-label="Instagram" 
                       class="h-8 w-8 bg-gradient-to-br from-purple-600 via-pink-600 to-brand-yellow-500 rounded-full flex items-center justify-center hover:from-purple-500 hover:via-pink-500 hover:to-brand-yellow-400 transition-all duration-300 shadow-md hover:shadow-pink-500/50 hover:scale-110 transform">
                        <svg class="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                        </svg>
                    </a>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-center text-gray-400">
                        <svg class="h-5 w-5 mr-2 text-brand-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                    ...
                    <li class="flex items-start text-gray-400">
                        <svg class="h-5 w-5 mr-2 text-brand-yellow-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
        ...
        <div class="border-t border-gray-700 pt-6 text-center flex flex-col items-center text-sm text-gray-400">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.comestro.medbuzzy" 
               ...
               ">
                <img src="{{ asset("logo/playstore.png") }}" class="mb-3 max-h-10 w-auto" alt="Get our app on Google Play">
            </a>
