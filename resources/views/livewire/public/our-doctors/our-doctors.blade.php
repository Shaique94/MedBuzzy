        ...
        <div x-show="scrolled" 
            ...
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button type="button" @click="filterDrawerOpen = true"
                        class="flex items-center px-3 py-1.5 border border-gray-300 rounded-md text-xs sm:text-sm text-gray-700 hover:bg-gray-50 group transition-all duration-150">
