        ...
        <div class="max-w-2xl mx-auto mb-10">
            <form action="" method="GET" class="relative">
                <div class="relative">
                    ...
                    <button type="submit"
                        class="absolute right-3 mt-10 transform -translate-y-1/2 bg-teal-500 text-white p-2 rounded-full hover:bg-teal-600 transition">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-teal-700 mb-2">Gender</label>
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox"
                                    class="h-4 w-4 text-teal-500 focus:ring-teal-300 border-teal-300 rounded">
                                <span class="ml-2 text-teal-700">Male</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="checkbox"
                                    class="h-4 w-4 text-teal-500 focus:ring-teal-300 border-teal-300 rounded">
                                <span class="ml-2 text-teal-700">Female</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="flex-shrink-0 relative">
                                    ...
                                    <div
                                        class="absolute -bottom-2 right-0 bg-orange-500 text-white rounded-full p-1 shadow-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex-grow">
                                    ...
                                    <p class="text-teal-600 mb-3">{{ $doctor->qualification ?? 'N/A' }}</p>
                                    ...
                                    <div class="flex items-center gap-2 mb-3">
                                        <div class="flex text-orange-400">
                                            ...
                                            <span class="text-teal-400 ml-1">(24 reviews)</span>
                                        </div>
                                    </div>
                                ...
                                <div class="flex-shrink-0 flex flex-col items-end gap-4">
                                    ...
                                    <div class="flex flex-col gap-2 w-full sm:w-auto">
                                        <a wire:navigate href="{{ route('appointment', ['doctor_id' => $doctor->id]) }}"
                                            class="bg-teal-500 from-teal-500 to-cyan-500 text-white px-6 py-2 rounded-lg font-medium shadow hover:from-teal-600 hover:to-cyan-600 transition text-center">
                                            Book Appointment
                                        </a>
