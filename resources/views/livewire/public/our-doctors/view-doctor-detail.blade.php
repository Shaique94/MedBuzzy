                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-brand-blue-600 truncate">
                            {{ $doctor->department->name ?? 'General Medicine' }}</p>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-4 mb-6">
                            <div class="flex flex-col items-center bg-gray-50 p-4 rounded-lg border border-gray-100">
                                ...
                                <div class="text-sm text-gray-600">Based on {{ $countFeedback }}
                                    {{ $countFeedback == 1 ? 'review' : 'reviews' }}</div>
                            </div>
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    @for ($i = 5; $i >= 1; $i--)
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span
                                                class="text-sm text-gray-600 w-12">{{ $ratingCounts[$i] ?? 0 }}</span>
                                        </div>
                                    @endfor
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex justify-between items-center mt-3">
                                    ...
                                    <a wire:navigate
                                        href="{{ route('doctor-detail', ['slug' => $relatedDoctor->slug]) }}"
