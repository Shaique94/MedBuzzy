    ...
    <div class="container mx-auto max-w-6xl">
            ...
            <div class="flex flex-col md:flex-row gap-6 p-6 md:p-8">
                ...
                <div class="flex-shrink-0 relative self-center md:self-start">
                    <div class="relative">
                        ...
                        @else
                            <div class="w-32 h-32 md:w-40 md:h-40 rounded-full bg-teal-100 border-4 border-white flex items-center justify-center shadow-lg">
                ...
                <div class="flex-grow">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4">
                        <span class="bg-teal-50 text-teal-800 px-3 py-1 rounded-full font-medium text-sm border border-teal-100"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <template x-for="service in doctor.services.slice(0, showAllServices ? doctor.services.length : 3)" :key="service.name">
                                <span class="bg-cyan-50 text-cyan-800 text-xs px-3 py-1.5 rounded-full border border-cyan-100" 
                    ...
                    <div class="hidden md:flex flex-wrap items-center justify-between gap-4 mt-6 pt-4 border-t border-teal-100">
        ...
        <div class="bg-white rounded-xl border border-teal-100 mb-8 overflow-hidden sticky top-0 z-10 shadow-sm">
            <nav class="flex overflow-x-auto no-scrollbar">
                <button @click="tab = 'about'"
                    :class="tab === 'about' ? 'border-teal-500 text-teal-700 bg-teal-50' : 'border-transparent text-teal-600 hover:text-teal-700 hover:bg-teal-50'"
                ...
                <button @click="tab = 'location'"
                    :class="tab === 'location' ? 'border-teal-500 text-teal-700 bg-teal-50' : 'border-transparent text-teal-600 hover:text-teal-700 hover:bg-teal-50'"
                    class="px-6 py-4 font-medium border-b-2 whitespace-nowrap transition flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <button @click="tab = 'reviews'"
                    :class="tab === 'reviews' ? 'border-teal-500 text-teal-700 bg-teal-50' : 'border-transparent text-teal-600 hover:text-teal-700 hover:bg-teal-50'"
                    class="px-6 py-4 font-medium border-b-2 whitespace-nowrap transition flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                    </svg>
                    Reviews
                    <span class="bg-teal-100 text-teal-800 text-xs px-2 py-0.5 rounded-full" x-text="doctor.reviews.length"></span>
                </button>
                <button @click="tab = 'hours'"
                    :class="tab === 'hours' ? 'border-teal-500 text-teal-700 bg-teal-50' : 'border-transparent text-teal-600 hover:text-teal-700 hover:bg-teal-50'"
                    class="px-6 py-4 font-medium border-b-2 whitespace-nowrap transition flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-teal-50 rounded-xl p-5 border border-teal-100">
                    ...
                    <p class="text-teal-700 leading-relaxed">
                        Dr. <span x-text="doctor.name"></span> is a <span x-text="doctor.department"></span> specialist 
                ...
                <div class="bg-teal-50 rounded-xl p-5 border border-teal-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <template x-for="service in doctor.services" :key="service.name">
                            <div class="bg-white p-3 rounded-lg border border-teal-100 hover:border-teal-200 transition">
                ...
                <div class="bg-teal-50 rounded-xl p-5 border border-teal-100">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-teal-700">Board Certified in <span x-text="doctor.department"></span></p>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="bg-white p-2 rounded-full border border-teal-200 mt-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="text-center pt-2">
                    <div class="inline-block bg-white p-5 rounded-xl border border-teal-100 max-w-lg">
                        <p class="italic text-teal-600">
                            "My philosophy is to treat every patient with compassion and respect, providing personalized care tailored to your unique needs."
                        </p>
        ...
        <div x-show="tab === 'location'" x-transition class="bg-white rounded-xl border border-teal-100 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:hidden">
                    <label for="location-select" class="block text-sm font-medium text-teal-700 mb-2">Select Location</label>
                    <select id="location-select" x-model="activeLocation" class="w-full rounded-lg border-teal-200 text-teal-700 focus:border-teal-500 focus:ring-teal-500">
                ...
                <div class="hidden lg:block space-y-3">
                    <template x-for="(location, index) in doctor.locations" :key="index">
                        <button @click="activeLocation = index"
                            :class="activeLocation === index ? 'bg-teal-100 border-teal-300' : 'bg-white border-teal-100 hover:bg-teal-50'"
                            class="w-full text-left p-4 rounded-lg border transition flex items-center gap-3">
                            <div class="flex-shrink-0 h-10 w-10 rounded-full bg-teal-50 border border-teal-200 flex items-center justify-center">
                ...
                <div class="lg:col-span-2">
                    <template x-for="(location, index) in doctor.locations" :key="index">
                        <div x-show="activeLocation === index" class="bg-teal-50 rounded-xl overflow-hidden border border-teal-100">
                            <!-- Location Header -->
                            ...
                            <div class="p-5">
                                <div class="space-y-4">
                                    ...
                                    <div class="mt-6 rounded-lg overflow-hidden border border-teal-200">
                                        <div class="aspect-w-16 aspect-h-9 bg-teal-100 flex items-center justify-center">
                                            <div class="text-center p-6">
                                                ...
                                                <p class="text-sm text-teal-600 mt-1">Interactive map would be displayed here</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="bg-teal-50 rounded-xl p-5 border border-teal-100">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    @foreach ($allDays as $day)
                        ...
                        <div class="flex items-center p-4 rounded-lg {{ $isToday ? 'bg-white shadow-md border-2 border-teal-300' : ($isAvailable ? 'bg-white border border-teal-100' : 'bg-gray-50 border border-gray-100') }}">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-amber-700">
                            ...
                            <span class="font-medium">{{$doctor->user->phone}}</span> and follow the prompts to reach the 
                            on-call provider.
                        </p>
                    </div>
                </div>
