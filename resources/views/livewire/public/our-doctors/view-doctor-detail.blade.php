<div x-data="{
    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-teal-100 p-6 mb-8">
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="flex-shrink-0 relative">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($doctor->user->name) }}&background=0D9488&color=fff&size=200" 
                ...
                <div class="flex-grow">
                    ...
                    <div class="flex flex-wrap items-center gap-4 mb-4">
                        <span class="bg-teal-100 text-teal-700 px-3 py-1 rounded-full font-medium" x-text="doctor.department"></span>
                    ...
                    <div class="flex items-center gap-2 text-teal-600 mb-4">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 12.414a4 4 0 00-5.657 5.657l4.243 4.243a8 8 0 0011.314-11.314l-4.243-4.243a1 1 0 00-1.414 1.414l4.243 4.243a6 6 0 01-8.486 8.486l-4.242-4.242a1 1 0 00-1.414 1.414l4.242 4.243a4 4 0 005.657-5.657l-4.243-4.243a1 1 0 00-1.414 1.414l4.243 4.243z"></path>
                        </svg>
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <template x-for="service in doctor.services" :key="service.name">
                            <span class="bg-cyan-100 text-cyan-800 text-sm px-3 py-1 rounded" x-text="service.name"></span>
                        </template>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <a wire:navigate href="{{ route('appointment', ['doctor_id' => $doctor->id]) }}" class=" bg-teal-500 text-white px-8 py-3 rounded-lg font-medium shadow hover:from-teal-600 hover:to-cyan-600 transition">
                            BOOK APPOINTMENT
                    </a>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-teal-100 mb-8 overflow-hidden">
            <nav class="flex overflow-x-auto">
                <button @click="tab = 'about'" 
                        :class="tab === 'about' ? 'border-teal-500 text-teal-700' : 'border-transparent text-teal-500 hover:text-teal-700'"
                        class="px-6 py-4 font-medium border-b-2 whitespace-nowrap">Overview</button>
                <button @click="tab = 'location'" 
                        :class="tab === 'location' ? 'border-teal-500 text-teal-700' : 'border-transparent text-teal-500 hover:text-teal-700'"
                        class="px-6 py-4 font-medium border-b-2 whitespace-nowrap">Locations</button>
                <button @click="tab = 'reviews'" 
                        :class="tab === 'reviews' ? 'border-teal-500 text-teal-700' : 'border-transparent text-teal-500 hover:text-teal-700'"
                        class="px-6 py-4 font-medium border-b-2 whitespace-nowrap">Reviews</button>
                <button @click="tab = 'hours'" 
                        :class="tab === 'hours' ? 'border-teal-500 text-teal-700' : 'border-transparent text-teal-500 hover:text-teal-700'"
                        class="px-6 py-4 font-medium border-b-2 whitespace-nowrap">Business Hours</button>
            </nav>
        </div>

        <!-- About Section -->
        <div x-show="tab === 'about'" x-transition class="bg-white rounded-xl shadow-sm border border-teal-100 p-6 mb-8">
            <h2 class="text-xl font-bold text-teal-800 mb-4">About Me</h2>
            <p class="text-teal-700 leading-relaxed" x-text="doctor.about"></p>
        </div>

        <!-- Locations Section -->
        <div x-show="tab === 'location'" x-transition class="bg-white rounded-xl shadow-sm border border-teal-100 p-6 mb-8">
        ...
        <!-- Reviews Section -->
        <div x-show="tab === 'reviews'" x-transition class="bg-white rounded-xl shadow-sm border border-teal-100 p-6 mb-8">
            ...
            <div class="space-y-6">
                ...
                <div class="pt-4">
                    <button class="bg-teal-100 text-teal-700 px-4 py-2 rounded-lg font-medium hover:bg-teal-200 transition">
                        Leave a Review
                    </button>
                </div>
            </div>
        ...
        <div x-show="tab === 'hours'" x-transition class="bg-white rounded-xl shadow-sm border border-teal-100 p-6 mb-8">
