    ...
    class="min-h-screen bg-gray-50 relative overflow-hidden">
                ...
                <div class="space-y-8">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <div class="flex flex-col sm:flex-row gap-3">
                                            <a wire:navigate href="tel:{{ $doctor->user->phone ?? '+91 943-080-8079' }}" 
                                            ...
                                            <a wire:navigate href="https://maps.google.com/?q=@if($doctor->city && $doctor->state){{ urlencode($doctor->city . ', ' . $doctor->state . ', India') }}@else Purnea,Bihar,India @endif" 
                                               target="_blank"
                    ...
                    <div x-show="tab === 'reviews'" x-transition class="bg-white rounded-xl shadow-md border border-gray-200 p-6 md:p-8">
                        ...
                        <div class="mt-6 text-center">
                            ...
                            @else
                                <a wire:navigate href="{{ route('login') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-6 rounded-lg inline-flex items-center gap-2 transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="showContactModal" 
            ...
            <div class="bg-white rounded-2xl p-6 max-w-md w-full">
                ...
                <div class="space-y-4">
                    <a wire:navigate href="tel:{{ $doctor->user->phone ?? '+919430808079' }}" 
                    ...
                    <a wire:navigate href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', $doctor->user->phone ?? '919430808079') }}" 
                       target="_blank"
                       class="flex items-center gap-3 p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
