...
}" x-init="calculateWidths(); window.addEventListener('resize', calculateWidths)" class="py-16 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            <button @click="scrollPrev" 
                    ...
                    :class="scroll <= 0 ? 'opacity-50 cursor-not-allowed' : 'opacity-100'"
                    :disabled="scroll <= 0">
            ...
            <div x-ref="container" class="grid grid-flow-col auto-cols-max md:auto-cols-min gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth">
                @php
                    // Define icons and colors for departments (fallbacks if needed)
                    $icons = [
                        'General Medicine' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>',
                        'Cardiology' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>',
                        'Dermatology' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>',
                        'Pediatrics' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path>',
                        'Orthopedics' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"></path>',
                        'Gynecology' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 15H7.5C6.12 15 5 16.12 5 17.5M16 15h.5c1.38 0 2.5 1.12 2.5 2.5M7 11a3 3 0 116 0 3 3 0 01-6 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17.75l-1 1.5h2l-1 1.5"></path>',
                        'Neurology' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>',
                        'Dentistry' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>',
                        'Psychiatry' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>',
                        'ENT' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>',
                    ];
                ...
                @foreach ($departments as $department)
                    ...
                    <a href="{{ route('our-doctors', ['department_id' => $department->id]) }}"
                       class="group text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 w-40 md:w-48 snap-start">
                        <div class="w-16 h-16 mx-auto mb-4 bg-{{ $color }}-100 rounded-full flex items-center justify-center group-hover:bg-{{ $color }}-200 transition-colors">
                            <svg class="w-8 h-8 text-{{ $color }}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                {!! $icon !!}
                            </svg>
                        </div>
                        <h3 class="font-semibold text-gray-800 group-hover:text-{{ $color }}-600 transition-colors">{{ $name }}</h3>
                        <p class="text-sm text-gray-500 mt-1">{{ $doctorCount }} @if ($doctorCount > 1) Doctors @else Doctor @endif</p>
                        </p>
                    </a>
                @endforeach
            </div>
                ...
                <div
                    ...
                    <div class="p-6 flex-grow flex flex-col">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-brand-teal-600 font-medium text-sm">{{ $doctor->department->name }}</p>
                        </div>
    ...
    <div class="container mx-auto px-8 lg:px-16">
        <div class="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div class="lg:w-1/2">
                ...
                <p class="text-xl text-gray-600 mb-12 leading-relaxed">Book your appointment with ease through our
                ...
                <div class="space-y-8">
                    <div class="flex items-start space-x-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Sign up with your basic details and verify your identity for
                                secure access</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Browse through various medical specialties and find the right
                                department</p>
                        </div>
                    </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-8 lg:px-16">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Stay informed with the latest healthcare news, tips,
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-4 leading-relaxed">Learn why telemedicine is becoming the preferred
