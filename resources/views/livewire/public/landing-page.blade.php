...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-8 lg:px-16">
        <div class="text-center mb-16">
            <h2 class="text-4xl lg:text-5xl font-bold text-gray-800 mb-6">Browse by Specialities</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Find the right specialist for your healthcare needs</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl flex items-center justify-center group-hover:from-orange-200 group-hover:to-orange-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-orange-600 transition-colors">Urology</h3>
                <p class="text-gray-500 text-sm mt-2">50+ Doctors</p>
            </div>
            
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-teal-100 to-teal-200 rounded-2xl flex items-center justify-center group-hover:from-teal-200 group-hover:to-teal-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-teal-600 transition-colors">Neurology</h3>
                <p class="text-gray-500 text-sm mt-2">30+ Doctors</p>
            </div>
            
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-green-100 to-green-200 rounded-2xl flex items-center justify-center group-hover:from-green-200 group-hover:to-green-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-green-600 transition-colors">Orthopedic</h3>
                <p class="text-gray-500 text-sm mt-2">40+ Doctors</p>
            </div>
            
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-red-100 to-red-200 rounded-2xl flex items-center justify-center group-hover:from-red-200 group-hover:to-red-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-red-600 transition-colors">Cardiologist</h3>
                <p class="text-gray-500 text-sm mt-2">25+ Doctors</p>
            </div>
            
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center group-hover:from-blue-200 group-hover:to-blue-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-blue-600 transition-colors">Dentist</h3>
                <p class="text-gray-500 text-sm mt-2">35+ Doctors</p>
            </div>
            
            <div class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center group-hover:from-purple-200 group-hover:to-purple-300 transition-all duration-300">
                    <svg class="w-10 h-10 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                    </svg>
                </div>
                <h3 class="font-bold text-gray-800 text-lg group-hover:text-purple-600 transition-colors">Diagnostic</h3>
                <p class="text-gray-500 text-sm mt-2">20+ Centers</p>
            </div>
        </div>
        
        <div class="text-center mt-12">
            <a href="/specialties" class="inline-flex items-center px-8 py-4 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700 transition-colors">
...
<!-- Book Our Best Doctor Section -->
<section class="py-20 bg-white">
    <div class="container mx-auto px-8 lg:px-16">
        <div class="text-center mb-16">
            <h2 class="text-4xl lg:text-5xl font-bold text-gray-800 mb-6">Meet Our Expert Doctors</h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Connect with verified healthcare professionals who are committed to providing exceptional care</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Doctor Card 1 -->
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group">
                <div class="relative">
                ...
                <div class="p-6">
                    <h3 class="font-bold text-xl text-gray-800 mb-2 group-hover:text-orange-600 transition-colors">Dr. Neraj Anand</h3>
                    <p class="text-teal-600 font-medium mb-3">Eye Specialist</p>
                    ...
                    <div class="mb-4">
                        <p class="text-gray-600 text-sm mb-1">15 Years Experience</p>
                        <p class="text-2xl font-bold text-gray-800">₹4,000</p>
                    </div>
                    <div class="flex space-x-3">
                        <button class="flex-1 bg-teal-50 border border-teal-200 text-teal-700 py-3 px-4 rounded-xl text-sm font-semibold hover:bg-teal-100 transition-colors">View Profile</button>
                        <button class="flex-1 bg-orange-600 text-white py-3 px-4 rounded-xl text-sm font-semibold hover:bg-orange-700 transition-colors">Book Now</button>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group">
                ...
                <div class="p-6">
                    <h3 class="font-bold text-xl text-gray-800 mb-2 group-hover:text-orange-600 transition-colors">Dr. Abhishek Anand</h3>
                    <p class="text-teal-600 font-medium mb-3">Dentist</p>
                    <div class="flex items-center mb-4">
                        <div class="flex text-yellow-400">
                            ★★★★★
                        </div>
                    ...
                    <div class="mb-4">
                        <p class="text-gray-600 text-sm mb-1">10 Years Experience</p>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group">
                ...
                <div class="p-6">
                    <h3 class="font-bold text-xl text-gray-800 mb-2 group-hover:text-orange-600 transition-colors">Dr. J P Yadav</h3>
                    ...
                    <div class="mb-4">
                        <p class="text-gray-600 text-sm mb-1">8 Years Experience</p>
                        <p class="text-2xl font-bold text-gray-800">₹3,000</p>
                    </div>
                    <div class="flex space-x-3">
                        <button class="flex-1 bg-teal-50 border border-teal-200 text-teal-700 py-3 px-4 rounded-xl text-sm font-semibold hover:bg-teal-100 transition-colors">View Profile</button>
                        <button class="flex-1 bg-orange-600 text-white py-3 px-4 rounded-xl text-sm font-semibold hover:bg-orange-700 transition-colors">Book Now</button>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group">
                ...
                <div class="p-6">
                    <h3 class="font-bold text-xl text-gray-800 mb-2 group-hover:text-orange-600 transition-colors">Dr. ABC Anand</h3>
                    ...
                    <div class="mb-4">
                        <p class="text-gray-600 text-sm mb-1">12 Years Experience</p>
        ...
        <div class="text-center mt-16">
            <a href="/doctors" class="inline-flex items-center px-8 py-4 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700 transition-colors">
                View All Doctors
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
    ...
    <div class="container mx-auto px-8 lg:px-16">
        <div class="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div class="lg:w-1/2">
                ...
                <div class="mt-12">
                    <a href="/book-appointment" class="inline-flex items-center px-8 py-4 bg-orange-600 text-white font-semibold rounded-xl hover:bg-orange-700 transition-colors">
                        Start Booking Now
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                        </svg>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-8 lg:px-16">
            ...
            <article class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group">
                <div class="relative">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-orange-600 text-white text-xs px-3 py-1 rounded-full font-medium">Featured</span>
                    </div>
                </div>
                <div class="p-6">
        ...
        <div class="text-center mt-16">
            <a href="/blog" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-600 to-teal-600 text-white font-semibold rounded-xl hover:from-orange-700 hover:to-teal-700 transition-all duration-300">
                View All Articles
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                </svg>
