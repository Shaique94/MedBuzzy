        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <button @click="scrollPrev"
                    ...
                    class="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 lg:-translate-x-8 z-10 bg-white rounded-full p-2 shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none" aria-label="Previous slide"
                    ...
                    @foreach ($departments as $department)
                        ...
                        <a wire:navigate href="{{ route('our-doctors', ['department_id' => $department->id]) }}"
                           ...
                           class="flex flex-col items-center bg-white rounded-xl shadow hover:shadow-md border border-brand-blue-100 px-6 py-5 min-w-[180px] snap-center transition-all duration-200">
                            <div class="mb-3">
                                <svg class="w-10 h-10 text-brand-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <circle cx="12" cy="12" r="10" stroke-width="2"></circle>
                                    <text x="12" y="16" text-anchor="middle" font-size="10" fill="currentColor">{{ substr($department->name, 0, 1) }}</text>
                                </svg>
                            </div>
                    ...
                    <div class="bg-white rounded-xl border border-brand-blue-100 shadow-sm hover:shadow-md transition-all duration-300" wire:key="doctor-{{ $doctor->id }}">
                        <div class="relative bg-brand-blue-50 rounded-t-xl p-4 flex items-center">
                            <img src="{{ $doctor->image ?? 'https://ui-avatars.com/api/?name=' . urlencode($doctor->user->name) . '&background=random&rounded=true' }}"
                                 alt="Dr. {{ $doctor->user->name }}" class="w-16 h-16 rounded-full border-4 border-white object-cover shadow" loading="lazy">
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900">Dr. {{ $doctor->user->name }}</h3>
                                <p class="text-brand-blue-600 text-xs font-medium">{{ $doctor->department->name ?? 'General' }}</p>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-xl p-6 text-center shadow-lg border border-brand-blue-100 relative">
                    <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-brand-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-semibold shadow-md">1</div>
                ...
                <!-- Step 3 -->
                <div class="bg-white rounded-xl p-6 text-center shadow-lg border border-brand-blue-100 relative">
                    <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-brand-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-semibold shadow-md">3</div>
                    <div class="h-32 flex items-center justify-center">
