    ...
    <div class="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.outside="open = false" x-transition:enter="transition ease-out duration-100"
                ...
                <!-- Settings -->
                <a wire:navigate href="#" class="flex items-center gap-3 px-4 py-2.5 sm:py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition duration-150">
