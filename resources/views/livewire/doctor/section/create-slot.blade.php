<div>
    ...
    @if($showForm)
        <form wire:submit.prevent="save" class="space-y-6 mb-8 bg-white p-6 rounded-lg shadow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="slot_duration_minutes" class="block text-sm font-medium text-gray-700 mb-1">Slot Duration (minutes)</label>
                ...
                <div>
                    ...
                    <input type="number" wire:model="patients_per_slot" id="patients_per_slot" min="1" max="10"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                @error('available_days') <span class="mt-1 text-sm text-red-600">{{ $message }}</span> @enderror
            </div>
